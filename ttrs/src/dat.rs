...
{ pub order: OrderResponse,
  ...
  // Known fields from the extra/debug bag (promoted for direct access + typing)
  #[serde(default)]
  pub source: Option<String>,
  #[serde(default, rename = "terminal-at")]
  pub terminal_at: Option<String>,
  #[serde(default, rename = "ext-exchange-order-number")]
  pub ext_exchange_order_number: Option<String>,
  #[serde(default, rename = "ext-global-order-number")]
  pub ext_global_order_number: Option<i64>,
  #[serde(default, rename = "ext-client-order-id")]
  pub ext_client_order_id: Option<String>,
  // Still catches every unknown/future/top-level field that appears
  #[serde(flatten)]
